...
function createseating(){
  ...
  for (var i = 0; i < 10; i++){
    for (var j = 0; j < 10; j++){
      var leftSeatingStyle = "<div class='seat available' style='transform:skew(10deg); float:left'></div>";
      var rightSeatingStyle = "<div class='seat available' style='transform:skew(-10deg); float:right'></div>";
      seatingValue.push(leftSeatingStyle);
      seatingValue.push(rightSeatingStyle);
