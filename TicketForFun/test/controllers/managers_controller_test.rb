...
class ManagersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manager" do
    assert_difference('Manager.count') do
      post managers_url, params: { manager: { code: @manager.code, email: @manager.email, name: @manager.name, password: @manager.password } }
    end
  ...
  test "should update manager" do
    patch manager_url(@manager), params: { manager: { code: @manager.code, email: @manager.email, name: @manager.name, password: @manager.password } }
